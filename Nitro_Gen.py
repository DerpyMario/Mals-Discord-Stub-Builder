    ...
    def main(self):  # The main function contains the most important code
        ...
        if os.name == "nt":  # If the system is windows
            ...
            ctypes.windll.kernel32.SetConsoleTitleW(
                "Nitro Generator and Checker - Made by" + name)  # Change the
        else:  # Or if it is unix
            print(f'\33]0;Nitro Generator and Checker\a', end='',
                  flush=True)  # Update title of command prompt

        time.sleep(2)  # Wait a few seconds
        self.slowType("Made by:" + name, .02)  # Print who developed the code
        ...
        self.slowType("\nDo you wish to use a discord webhook? \nIf so type it here or press enter to ignore: ", .02,
                      newLine=False)
        ...
        for i in range(num):  # Loop over the amount of codes to check
            ...
            if os.name == "nt":  # If the system is windows
                ...
                print(
                    ...
                    end='', flush=True)  # Change the title
